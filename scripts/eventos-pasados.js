...
//recibe los eventos de AJAX
function cargaEventos(eventosGuardados) {
    //TODO:Cambio a AJAX

    //fintro eventos pasados
    ...
    /*if (localStorage.eventos && localStorage != '[]') {
        ...
        arrayEventos = filtraEventosPasados(arrayEventos)
...
//retorna array eventos pasados
function filtraEventosPasados(arrayEventos) {
...
//Retorna Array de los eventos ordenados
